            ...
            <input type="hidden" name="id" value="<?= $id ?>">
              <!-- <div class="box-body"> -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir" value="<?= $row ['tempat_lahir']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Tanggal Lahir</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control tanggal" placeholder="Tanggal Lahir" name="tanggal_lahir" value="<?= $row ['tanggal_lahir']; ?>">
                  </div>
                </div>
                <div class="form-group">
